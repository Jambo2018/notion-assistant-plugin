export const ICON_MAP = {
	...
	['todoList']:
		'<svg  viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"><path d="M977.2 782.8v-736H46.8v930.4h889.1v-76H122.8V122.8h778.4v660z" fill="#454545" p-id="1500"></path><path d="M274.8 459.8L227.2 519l244.2 196 385.1-373.3-52.9-54.6-336.9 326.7z" fill="#454545" p-id="1501"></path></svg>',
	['linkBookMark']:
...
export const CMD_CONFIG = {
	['insert-callout']: {
		title: 'Callout',
		icon: 'call-out',
		cmd: "typing-assistant:insert-callout"
	},
	'insert-tag': {
		title: 'Tag',
		icon: 'tag',
